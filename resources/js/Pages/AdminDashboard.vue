...
export default {
    ...
    methods: {
        fetchAllTransaction() {
            axios.get(route("alltransaction.fetch")).then((res) => {
        ...
        formatDateTime(datetime) {
            ...
            const formattedDate = date.toLocaleDateString(); // Outputs: MM/DD/YYYY or based on locale
        ...
        filterTransactions() {
            // This method is automatically invoked when searchQuery or filterDate is changed.
            // You don't need to manually trigger this if you have a computed property like `filteredTransactions`.
        },
